    ...
    return (
        <div className={`flex`}>
            ...
            <header className="flex flex-grow justify-center text-white">
                <nav className=" justify-center" arihidden lg:flexa-label="Global">
                ...
                <div className="relative mt-2 ">
                    ...
                    <div className="absolute inset-y-0 rounded-r-full px-4 right-0 flex items-center bg-gradient-to-r from-indigo-500 to-purple-800 cursor-pointer">
                        {IconeSearch}
                    </div>
                </div>
