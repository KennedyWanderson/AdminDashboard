            ...
            <header className="flex flex-grow justify-center text-white">
                ...
                <div className="relative mt-2 ">
                    ...
                    <input
                        ...
                        name="search"
                        id="search"
                        className="w-full rounded-l-2xl rounded-r-full py-2 px-6"
                    >
                        
                    </input>
                    <div className="absolute inset-y-0 px-4 right-0 flex items-center rounded-r-2xl bg-gradient-to-r from-indigo-500 to-purple-800 cursor-pointer">
                        {IconeSearch}
                    </div>
                </div>
