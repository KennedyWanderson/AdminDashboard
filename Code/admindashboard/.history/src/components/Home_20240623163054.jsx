        ...
        <div className="py-24 sm:py-32 bg-gray-800">
            <div className="mx-auto max-w-full px-6 lg:px-8">
                <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
                    ...
                    <div className="mx-auto flex max-w-xs flex-col w-full border-2 p-10 border-indigo-800 gap-y-4">
                        <dt className="text-base leading-7 text-white">Like</dt>
                        <dd className="order-first text-3xl font-semibold tracking-tight text-white sm:text-5xl">150 {IconeLike}</dd>
                    </div>
                    <div className="mx-auto flex max-w-xs flex-col w-full border-2 p-10 border-indigo-800 gap-y-4">
