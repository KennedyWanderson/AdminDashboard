            ...
            <header className="flex flex-grow justify-center text-white">
                ...
                <div className="relative mt-2 ">
                    ...
                    <input
                        ...
                        name="search"
                        id="search"
                        className="w-full rounded-none py-2 px-6"
                    >
                        
                    </input>
                    <div className="absolute inset-y-0 px-4 right-0 flex items-center bg-gradient-to-r from-indigo-500 to-purple-800 hover:bg-indigo-800 cursor-pointer">
                        {IconeSearch}
                    </div>
                </div>
