        ...
        <div className={`flex`}>
            ...
            <header className="flex flex-grow justify-center text-white">
                ...
                <div className="relative mt-2 ">
                    ...
                    />
                    <div className="absolute inset-y-0 px-4 right-0 flex items-center border-none rounded-r-full bg-gradient-to-r from-indigo-500 to-purple-800 cursor-pointer">
                        {IconeSearch}
                    </div>
                </div>
