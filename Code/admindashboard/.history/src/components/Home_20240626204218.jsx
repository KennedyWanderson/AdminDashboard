...
export default function HomePage() {
    return (
        <div className="py-24 sm:py-32 bg-gray-800 min-h-screen flex flex-col justify-between">
            <div className="mx-auto max-w-full px-6 lg:px-8 mb-8">
            ...
            <div className="mx-auto max-w-full px-6 lg:px-8">
                <div className="border-2 p-10 rounded-2xl shadow-2xl shadow-indigo-500">
