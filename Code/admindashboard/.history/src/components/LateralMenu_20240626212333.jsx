...
import { IconeAcademic, IconeAjustes, IconeCasa, IconeCheck, IconeMenu, IconeSair, IconeSearch, IconeSino } from "./icons";
...
export default function LateralMenu({ setActiveComponent }) {
    ...
    return (
        <div className="relative">
            <button
                className="p-4 bg-gray-200 text-gray-700 dark:bg-gray-900 dark:text-gray-200 rounded-full lg:hidden fixed top-4 left-4 z-50"
