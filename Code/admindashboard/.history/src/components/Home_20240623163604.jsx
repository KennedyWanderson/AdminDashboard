import { IconeComment, IconeEye, IconeLike } from "./icons";
            ...
            <div className="mx-auto max-w-full px-6 lg:px-8">
                <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
                    ...
                    <div className="mx-auto flex items-center max-w-xs flex-col w-full border-2 p-10 border-indigo-800 gap-y-4">
                        ...
                        <dd className="order-first text-3xl flex items-center fap-10 font-semibold tracking-tight text-white sm:text-5xl">320 {IconeComment}</dd>
                    </div>
                    <div className="mx-auto flex items-center max-w-xs flex-col w-full border-2 p-10 border-indigo-800 gap-y-4">
