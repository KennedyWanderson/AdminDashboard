            ...
            <div>
                <div className="relative mt-2 rounded-md shadow-sm">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <span className="text-gray-500 sm:text-sm">Searc here...</span>
                    </div>
                    <input type="text" name="search" id="search" className=" w-full rounded-2xl border-6 border-indigo-600 focus:border-indigo-700 py-2 px-6" />
