        ...
        <div className="py-24 sm:py-32 bg-gray-800">
            <div className="mx-auto max-w-full px-6 lg:px-8">
                <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
                    <div className="mx-auto flex items-center max-w-xs flex-col w-full border-2 rounded-2xl shadow-2xl shadow-indigo-200 p-10 border-indigo-800 gap-y-4">
                    ...
                    <div className="mx-auto flex items-center max-w-xs flex-col w-full border-2 rounded-2xl p-10 border-indigo-800 gap-y-4">
